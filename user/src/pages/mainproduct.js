...
function Mainproduct() {
  ...
  function addtocart(){
   ...
   Axios.post('http://localhost:1137/api/addtocart',{_id:_id,initval:initval,num:num,u_email:u_email,currentval:currentval, }).then((response)=>{
...
<button class="addtocart" id ="btnincrement"  onClick={addtocart} >Add to Cart</button>
         </>
                            }
